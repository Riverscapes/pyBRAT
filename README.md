This is the Beaver Restoration Assessment Tool (pyBRAT) source code and [documentation](http://brat.joewheaton.org) about it. pyBRAT is superseded by [sqlBRAT](http://tools.riverscapes.xyz/BRAT)
