...
def write_xml(output_folder, coded_veg, coded_hist, seg_network, inDEM, valley_bottom, landuse,
    ...
    if len(description) <= 300:
        description_element = xml_file.add_sub_element(brat_element, "MetaData", ["Name", description])
    if len(description) > 300:
        raise Exception("Description must be less than 300 characters.")
    if description is None:
        description_element = xml_file.add_sub_element(xml_file.root, "Description")
