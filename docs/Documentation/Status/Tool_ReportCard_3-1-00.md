...
| [Current Assessment](http://brat.riverscapes.xyz/Tools#tool-status) | ![operational]({{ site.baseurl }}/assets/images/tools/TRL_badges_pngs/TRL_orange/2_badges+status/24px/TRL_4_orange_24.png) [Operational Grade](http://brat.riverscapes.xyz/Documentation/Status/Tool_ReportCard_3-1-00) |
| Target Status | ![commercial]({{ site.baseurl }}/assets/images/tools/TRL_badges_pngs/TRL_orange/2_badges+status/24px/TRL_6_orange_24.png) Commercial Grade |
| Riverscapes Compliance | ![Pending]({{ site.baseurl}}/assets/images/rc/RiverscapesCompliantPending_28.png) [Pending](https://riverscapes.xyz/Tools/#tools-pending-riverscapes-compliance) |
