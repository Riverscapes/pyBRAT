...
def combFIS(in_network, model_run, scratch, max_DA_thresh):
    ...
    # build fis rule table
        ...
        rule40 = ctrl.Rule(ovc['frequent'] & sp2['blowout'] & splow['can'] & slope['probably'], density['none'])
        ...
        rule43 = ctrl.Rule(ovc['frequent'] & sp2['blowout'] & splow['probably'] & slope['probably'], density['none'])
